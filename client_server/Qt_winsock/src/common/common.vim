...
imap <F3> :!ctags -R --c++-kinds=+p --fields=+iaS --extra=+q . :TlistUpdate
...
nmap ,o :LookupFile 
nmap ,xroot :call SetSpecifiedPathTheRoot()
nmap ,root :call SetHereTheRoot()
...
map <F3> :!ctags -R --c++-kinds=+p --fields=+iaS --extra=+q . :TlistUpdate
...
set tabstop=4
set tags=tags,/usr/include/c++/tags,./tags
set whichwrap=b,s,<,>,[,]
...
set shortmess=aoO
badd +156 lightthread.c
badd +1 lightthread.h
badd +30 timespan.h
args ~/Documents/Project/PengGe/client_server/Qt_winsock/common/lightthread.c ~/Documents/Project/PengGe/client_server/Qt_winsock/common/lightthread.h
edit timespan.h
...
138
normal! zo
let s:l = 155 - ((23 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
155
